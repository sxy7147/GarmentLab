...
class FrankaConfig:
    # def __init__(self,franka_num:int=2,pos:list=[np.array([0,0,0]), np.array([1,0,0])],ori:list=[np.array([0,0,0]), np.array([0,0,np.pi])]):
    def __init__(self,franka_num:int=2,pos:list=[np.array([1,0,0]), np.array([0,0,0])],ori:list=[np.array([0,0,np.pi]), np.array([0,0,0])]):
